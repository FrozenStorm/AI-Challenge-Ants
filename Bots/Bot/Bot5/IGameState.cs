...
namespace Ants
{
    ...
    public interface IGameState
    {
        ...
        /// </summary>
        List<Ant> MyAtkAnts { get; set; }
        List<Ant> MyDefAnts { get; set; }
        List<Ant> MyExpAnts { get; set; }
        ...
        /// </summary>
        List<Location> FoodTiles { get; set; }
        ...
        Direction DirectionToTarget(IGameState state, int radius, Ant ant, int Target, int TargetLayer);

        Direction DirectionToLocation(IGameState state, int radius, Ant ant, Location Target);

        Direction AtkEnemy(IGameState state, Ant ant);

        bool Explore(IGameState state, Ant ant, int radius);

        void RandomMove(IGameState state, Ant ant);
        int test_y(int y);
        int test_x(int x);
