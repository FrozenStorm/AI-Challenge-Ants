...
namespace Ants 
{
	...
	public class Ants 
    {
        ...
        public static IDictionary<Location, Direction> Aim2 = new Dictionary<Location, Direction> 
        {
...
#if DEBUG
        public static IDictionary<Tile, Color> Aim3 = new Dictionary<Tile, Color> 
        {
			{ Tile.MyAnt,Color.Orange},
			{ Tile.EnemyAnt,Color.LightBlue},
			{ Tile.Dead,Color.Black},
			{ Tile.Land,Color.Green},
            { Tile.Food,Color.LightGray},
            { Tile.Water,Color.LightYellow},
            { Tile.Unseen,Color.Gray},
            { Tile.MyHill,Color.DarkOrange},
            { Tile.EnemyHill,Color.Blue}
		};
#endif	
