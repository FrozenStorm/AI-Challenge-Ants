...
namespace Ants 
{
	...
	public class GameState : IGameState 
    {
        ...
        {
			return GetIsPassable(location) && map[location.Row, location.Col] != Tile.MyAnt;
		}
        ...
        {
            map[newLoc.Row, newLoc.Col] = map[ant.Row, ant.Col];
