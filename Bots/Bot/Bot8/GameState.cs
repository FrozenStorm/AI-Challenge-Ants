...
namespace Ants 
{
	...
	public class GameState : IGameState 
    {
        ...
        public void UpdateAnts()
        {
            ...
            foreach (Ant ant in MyDefAnts) ant.turndone = false;
            foreach (Ant ant in MyExpAnts) ant.turndone = false;
            foreach (Ant ant in MyAtkAnts) ant.turndone = false;
        }
